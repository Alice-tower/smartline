...
/**
 * HomepageContactPresenter
 *
 * @author zpsong-tower <pingzisong2012@gmail.com>
 * @since 2021/7/25 10:26
 */
public class HomepageContactPresenter extends BasePresenter<IHomepageContract.View>
     ...
     */
    public HomepageContactPresenter(@NonNull IHomepageContract.View view) {
        super(view);
    }
